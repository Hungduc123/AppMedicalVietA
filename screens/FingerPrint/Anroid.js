...
import ShakingText from "./SkakingText.component";

// Based on https:/sithub.com/hieuvp/react-native-fingerprint-scanner/blob/master/examples/src/FingerprintPopup.component.android.js
...
class BiometricPopup extends Component {
  ...
  authCurrent() {
    FingerprintScanner.authenticate({
      description: this.props.description || "Sử dụng vân tay để chứng thực",
    })
      .then(() => {
